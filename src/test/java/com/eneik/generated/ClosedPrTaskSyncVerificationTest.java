...
public class ClosedPrTaskSyncVerificationTest {
    ...
    public void testTaskProcessedAndPrRejectedVerifyTaskFlowResetsOrHalts() {
        ...
        // Then the task flow halts correctly (the task transitions to failed, NOT transitioning to 'done')
        ...
        assertEquals("failed", reloadedActiveTask.getStatus(), "Active task should be transitioned to failed status");
